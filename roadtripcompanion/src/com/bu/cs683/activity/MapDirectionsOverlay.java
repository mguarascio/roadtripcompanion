...
public class MapDirectionsOverlay extends Overlay
{
	...
	public MapDirectionsOverlay(GeoPoint gp1, GeoPoint gp2, int mode) // GeoPoint is a int.
															// (6E)
	{
		this.gp1 = gp1;
		this.gp2 = gp2;
	...
	public MapDirectionsOverlay(GeoPoint gp1, GeoPoint gp2, int mode, int defaultColor)
	{
		this.gp1 = gp1;
		this.gp2 = gp2;
		this.mode = mode;
